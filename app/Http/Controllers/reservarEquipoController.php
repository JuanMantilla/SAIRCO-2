...
class reservarEquipoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //Además, asegura que se asigne la reserva a sólo un equipo nada m�s.
        $centinela=false;
        $contador= 0;
        ...
        foreach($equiposDisponibles as $resultados){
            ...
            if($resultados->estado == 0){
                ...
                foreach($softwares as $variable){
                    //Aseguro que intrese a esta condici�n s�lo cuando el software del equipo es igual al software que el usuario especific�
